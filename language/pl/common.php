...
$lang = array_merge($lang, array(
	...
	'BROWSING_FORUM_GUESTS'	=> array(
		0	=> '&nbsp;&nbsp;%2$s',
		1	=> '&nbsp;&nbsp;%2$s&nbsp; &raquo; &nbsp;%1$d gość',
		2	=> '&nbsp;&nbsp;%2$s&nbsp; &raquo; &nbsp;%1$d gości',
		3	=> '&nbsp;&nbsp;%2$s&nbsp; &raquo; &nbsp;%1$d gości',
	),
	'BUTTON_DELETE'         => 'Usuń',
	'BUTTON_EDIT'			=> 'Edytuj',
	...
	'BUTTON_PM'				=> 'PW',
	'BUTTON_PM_FORWARD'		=> 'Przekaż dalej',
	'BUTTON_PM_NEW'			=> 'Nowa wiadomość',
	...
	'COOKIE_CONSENT_MSG'	=> 'Strona używa plików cookies w celach statystycznych oraz funkcjonalnych. Warunki przechowywania i dostępu do plików cookies można określić w ustawieniach przeglądarki internetowej.',
	...
	'MARK_SUBFORUMS_READ'	=> 'Oznacz działy jako przeczytane',
	'MB'					=> 'MB',
	'MIB'					=> 'MiB',
	'MCP'					=> 'Panel moderacji',
	'MCP_SHORT'				=> 'Moderacja',
	...
	'NOTIFICATION_REPORT_PM'			=> 'zgłoszono prywatną wiadomość %1$s',
	'NOTIFICATION_REPORT_PM_CLOSED'		=> 'zamknięto zgłoszenie dotyczące prywatnej wiadomości %1$s',
	'NOTIFICATION_REPORT_POST'			=> 'zgłoszono post %1$s',
	'NOTIFICATION_REPORT_CLOSED'		=> 'zamknięto zgłoszenie %1$s',
	...
	'NO_ONLINE_USERS'			=> '0 użytkowników',
	...
	'ONLINE_USERS_TOTAL'		=> array(
		1	=> 'Online: <strong>%1$d</strong> &#124; %2$s i %3$s',
		2	=> 'Online: <strong>%1$d</strong> &#124; %2$s i %3$s',
		3	=> 'Online: <strong>%1$d</strong> &#124; %2$s i %3$s',
	),
	// "... :: x registered, y hidden and z guests"
	'ONLINE_USERS_TOTAL_GUESTS'	=> array(
		1	=> 'Online: <strong>%1$d</strong> &#124; %2$s, %3$s i %4$s',
		2	=> 'Online: <strong>%1$d</strong> &#124; %2$s, %3$s i %4$s',
		3	=> 'Online: <strong>%1$d</strong> &#124; %2$s, %3$s i %4$s',
	),
	'OPTIONS'					=> 'Opcje',
	...
	'SEARCH_KEYWORDS'			=> 'Szukaj według słów kluczowych',
	'SEARCHING_FORUMS'			=> 'Przeszukiwanie forów',
	'SEARCH_ACTIVE_TOPICS'		=> 'Aktualności',
	'SEARCH_FOR'				=> 'Szukaj',
	...
	'START_WATCHING_FORUM'		=> 'Obserwuj dział',
	'START_WATCHING_TOPIC'		=> 'Obserwuj temat',
	'STOP_WATCHING_FORUM'		=> 'Przestań obserwować dział',
	'STOP_WATCHING_TOPIC'		=> 'Przestań obserwować temat',
	...
	*/
	...
	'LINK_TO_MA'				=> 'Link do Metal Archives',
	'LINK_TO_MA_EXPLANATION'	=> 'Wklej link do strony zespołu na Metal Archives, a jego skład, dyskografia oraz ten link zostaną dodane na koniec posta.',
	'REFRESH_MA_INFO'			=> 'Zaktualizuj informacje z Metal Archives o zespole',
